    ...
    <div>
      {/* topbar */}
        ...
        <Flex justifyContent={"space-between"} height={{base:"40px",md:"60px",lg:"74px"}} borderBottom="1px solid gray" bgColor={'#013f7d'}>
          {/* Left of logo bar */}
          <Link href="/" _hover={{fontDecoration:"none"}} ml={{base:"20px",md:"50px",lg:"100"}} color="white" fontFamily="Impact" fontSize={{base:"20px",md:"40px",lg:"50px"}} w={{base:"100px",md:"205px",lg:"255px"}} h={{base:"10px",md:"20px",lg:"40px"}}>Adorama</Link>
          {/* Right of logo Bar */}
